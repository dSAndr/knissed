...
classx = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Kinseed 10th Anniversary'), 'class')
...
WebUI.click(findTestObject('Object Repository/Page_Home  Kinseed/span_Discover Kinseeds 10 year celebrations'))

//kinseed.com/10th-anniversary/ = WebUI.getUrl()
https: urlx = WebUI.getUrl()

WebUI.verifyMatch(urlx, 'https://kinseed.com/10th-anniversary/', true)
...
classz = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Kinseed 10th Anniversary'), 'class')
