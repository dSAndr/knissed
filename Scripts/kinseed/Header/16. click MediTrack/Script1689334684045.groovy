...
classx = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_MediTrack'), 'class')
...
WebUI.click(findTestObject('Page_Home  Kinseed/span_MediTrack'))

//kinseed.com/meditrack/ = WebUI.getUrl()
https: urlx = WebUI.getUrl()

WebUI.verifyMatch(urlx, 'https://kinseed.com/meditrack/', true)
...
classz = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_MediTrack'), 'class')
