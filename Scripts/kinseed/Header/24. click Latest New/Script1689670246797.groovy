...
classx = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Latest News'), 'class')
...
WebUI.click(findTestObject('Page_Home  Kinseed/span_Latest News'))

//kinseed.com/latestnews/ = WebUI.getUrl()
https: urlx = WebUI.getUrl()

WebUI.verifyMatch(urlx, 'https://kinseed.com/latestnews/', true)
...
classz = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Latest News'), 'class')
