...
classx = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Insights'), 'class')
...
WebUI.click(findTestObject('Object Repository/Page_Home  Kinseed/span_Insights'))
