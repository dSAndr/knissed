...
classx = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Product Fact Sheets'), 'class')
...
classz = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Product Fact Sheets'), 'class')
