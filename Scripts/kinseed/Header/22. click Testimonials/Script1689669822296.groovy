...
classx = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Testimonials'), 'class')
...
WebUI.click(findTestObject('Page_Home  Kinseed/span_Testimonials'))

//kinseed.com/our-customers/ = WebUI.getUrl()
https: urlx = WebUI.getUrl()

WebUI.verifyMatch(urlx, 'https://kinseed.com/our-customers/', true)
...
classz = WebUI.getAttribute(findTestObject('Page_Home  Kinseed/li_Testimonials'), 'class')
